...
if(!empty($this->width) and !empty($this->height) and !empty($this->video)) {
	...
	echo '
		<object data="'.$this->swfUrl.'" type="application/x-shockwave-flash" height="'.(int)$this->height.'" width="'.(int)$this->width.'"><param value="'.$bgcolor.'" name="bgcolor"><param value="true" name="allowFullScreen"><param value="always" name="allowScriptAccess"><param value="'.$this->id.'" name="id"><param value="file='.$this->video.($this->st ? "&st={$this->st}" : '').'" name="flashvars"></object>
